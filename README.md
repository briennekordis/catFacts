...
2. Make sure that all files are saved in the same location and that you have Node installed. 
3. From your comman line, navigate to the directory of where these files live
4. Run `npm start`. A broswer should launch that displays instructions and a button to press to render the cat facts. 
...
The API used for this app is from @alexwohlbruck cat-facts [repository](https://github.com/alexwohlbruck/cat-facts) which has the following Apache License:
